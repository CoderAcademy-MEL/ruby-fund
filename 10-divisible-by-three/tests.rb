...
describe 'is_div ' do
    ...
    it 'returns true where the number is divisible by 3' do
        expected = false
        actual = is_div(10)
...
describe 'process_array' do
    ...
    it 'returns an array of arrays where the first array contains all nums (given in the array argument) divisible by 3, and the second contains the remaining numbers.' do
        expected = [[30],[10,20]]
